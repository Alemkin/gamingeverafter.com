export var articles = [{
  ...
  title: 'Chapter Twelve: Trippy Daze',
  text: 'The group finds their way out of the maze of wildlife and nature, making their way to a new area, high on the adventure and other things...',
  fileName: 'sessiontwelve',
  tags: ['dnd', 'd&d', 'dnd5e', 'd&d5e', 'dungeonsanddragons', 'tabletop', 'rpg', 'tabletoprpg'],
  authors: ['Alexander Lemkin'],
  related: ['dnd', 'tootp']
}, {
